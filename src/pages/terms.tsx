  ...
  return (
    <main className="contentPage articleBody">
      ...
      <section>
        ...
        <p>
          You may use this website for kitchen estimate, quote-review, planning, education and enquiry purposes. The website is intended to help customers understand scope, assumptions, exclusions and next steps before project-specific review.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          You are responsible for ensuring you have permission to upload documents, photos, plans, drawings, appliance lists and existing quotes. Do not upload confidential third-party material you are not authorised to share, or unlawful, misleading, unsafe or irrelevant content.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          Site measure is required before project-specific pricing. Confirmed selections, site-condition review, access checks, service assumptions and written scope confirmation are required before contract pricing.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          Deposit, HBC, written contract, strata, DBP/class 2, engineered-stone, asbestos and licensed-trade prompts are general review flags only. They are not legal advice and do not provide compliance certainty. Project-specific confirmation is required.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          Electrical, plumbing and gas work must be scoped and performed by appropriately licensed trades. Online information is not a substitute for licensed trade inspection, site review or written trade scope.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          Apartment and strata works may require owners corporation approval, access coordination, work-hour limits, lift or parking bookings and further review. You are responsible for obtaining approvals unless a separate written service agreement says otherwise.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          Engineered-stone restrictions may affect benchtop and splashback options. Material selections require supplier and trade confirmation. The website may suggest alternative material pathways, but it does not certify material status or project suitability.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          Operon Kitchens may later offer detailed quote review, site measure, design/specification packages, paid reports or related services. Separate terms, price, inclusions, timing, cancellation and refund rules may apply when paid services are launched.
        </p>
      </section>
      ...
      <section>
        <h2>No guarantee</h2>
        <p>
          Operon Kitchens does not promise savings, project acceptance, a future project price or that another contractor will change their quote. The website is designed to improve scope clarity and review readiness before the next professional step.
        </p>
      </section>
