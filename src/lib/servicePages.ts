...
export const servicePages: ServicePage[] = [
  ...
  },
  {
    ...
    confidenceBoosters: ['Measured benchtop runs', 'Photos of each join and cut-out', 'Selected compliant material direction', 'Known sink, tap and cooktop requirements'],
    ...
    faqs: [['Can I choose engineered stone?', 'Restricted products require supplier and installer confirmation. The estimate directs users toward compliant alternatives.'], ['Do I need a full kitchen quote?', 'Not always, but sink, tap, appliances and splashback impacts should be checked.']],
  },
  {
